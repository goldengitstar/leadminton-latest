      ...
      >
        <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
          <h2 className="text-xl font-bold text-gray-900">
            Select Player for {tournament.name}
          </h2>
          <button
            onClick={onClose}
        ...
        <div className="px-6 py-6">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
            ...
            <div className="text-sm text-blue-800">
              <p>Minimum Level: {tournament.minPlayerLevel}</p>
          ...
          <div className="space-y-3 max-h-[400px] overflow-y-auto">
            ...
            {eligiblePlayers.length === 0 ? (
              <div className="text-center py-8 text-gray-500">
                ...
                <p className="text-sm">Players must be level {tournament.minPlayerLevel} or higher and not injured</p>
              </div>
            ) : (
              eligiblePlayers.map((player) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Player detailed stats when selected */}
                    {isSelected && (
                      <div className="mt-4 pt-4 border-t border-blue-200">
                        <div className="grid grid-cols-2 gap-4">
                          <div>
                            <h5 className="text-xs font-medium text-blue-800 mb-2">Technical Skills</h5>
                            <div className="space-y-1 text-xs">
                              <div className="flex justify-between">
                                <span>Smash:</span>
                                <span>{player.stats.smash}</span>
                              </div>
                              <div className="flex justify-between">
                                <span>Defense:</span>
                              ...
                              <div className="flex justify-between">
                                <span>Serve:</span>
                                <span>{player.stats.serve}</span>
                              </div>
                            </div>
                          </div>
                          <div>
                            <h5 className="text-xs font-medium text-blue-800 mb-2">Physical Stats</h5>
                            <div className="space-y-1 text-xs">
                              <div className="flex justify-between">
                                <span>Endurance:</span>
